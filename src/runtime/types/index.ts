...
export type { SelectOption } from '../components/forms/SelectField.vue'
export type { DataTableColumn } from '../components/display/DataTable.vue'
export type { BreadcrumbItem } from '../components/navigation/Breadcrumb.vue'
export type { TabItem } from '../components/navigation/Tabs.vue'
export type { DropdownMenuItem } from '../components/overlays/DropdownMenu.vue'
...
declare module '@vue/runtime-core' {
  export interface GlobalComponents {
    ...
    DateField: typeof import('../components/forms/DateField.vue')['default']
    ...
    KSDateField: typeof import('../components/forms/DateField.vue')['default']
